...
lora_0_A={}
lora_0_B={}
model_path = './resp_unwill/2480_lora/adapter_model.safetensors'
tensors = {}
...
model_mogu = LlamaForCausalLM.from_pretrained("lmsys/vicuna-7b-v1.5", device_map="auto", trust_remote_code=True)
